...
const personas = {
    ...
    "ESFJ": { name: "情绪人质", englishName: "HOSTAGE", archetype: "列维纳斯", code: "No.015", image: "images/ESFJ.png", declaration: "别人微信只回了一个 ‘哦 ’，<br>你已经把这辈子犯过的罪全复盘了一遍。", pathology: "你以为自己是讨好型人格，其实你是被共情深度绑架的囚徒。你无法对别人的局促、期待和痛苦视而不见，哪怕这会严重透支你自己。你努力维持所有人的体面和情绪价值，不是为了索取任何回报，而是因为你对这个世界怀有一种近乎病态的“无限责任感”。你的内耗，是对冷漠世界最悲壮的代偿。", origin: "你的精神底座是列维纳斯的“他者伦理学”。他认为，当“他者的面容”出现在你面前时，你就被施加了绝对的伦理命令。你对他者负有“无限的责任”，这种责任先于你的自由。你之所以疯狂内耗，是因为他者的需求永远先于你自身的边界。你不是在讨好社会，你是在替人类那匮乏的良知赎罪。", prescription: "列维纳斯说你对他者负有无限责任，但他没说你必须24小时在线。学会适时地“屏蔽面容”，是你在这个残酷世界里必须学会的自救指南。", partnerMate: "纯种牛马 (COW HORSE)", partnerEnemy: "卷王 (ROLL)" },
